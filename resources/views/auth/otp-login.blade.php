...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - OTP Login</title>
        ...
        <div class="relative z-10 flex min-h-screen items-center justify-center p-4">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-3xl font-bold text-white mb-2">Secure OTP Login</h1>
                    <p class="text-indigo-200/80 text-sm">Enter your email to receive a one-time password</p>
                </div>

                <!-- OTP Login Card -->
                <div class="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8">
                    <form method="POST" action="{{ route('auth.otp.login') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="text-center">
                            <p class="text-white/60 text-xs">
                                A one-time password will be sent to your email address for secure login.
                            </p>
                        </div>
                    </form>
                </div>
